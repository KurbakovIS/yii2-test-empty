 ...
 * - `{{%work_types}}`
 *
 * yii migrate/create create_work_categories_table --fields=name:string:notNull,cost:double:notNull,id_work_type:integer:foreignKey(work_types)
 */
class m190510_102546_create_work_categories_table extends Migration
{
    /**
     * {@inheritdoc}
     */
