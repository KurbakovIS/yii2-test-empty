 ...
 * - `{{%users}}`
 *
 * yii migrate/create create_garages_table --fields=name:string:notNull,id_vehicle:integer:foreignKey(vehicles),created_by:integer:notNull:foreignKey(users),created_at:integer:notNull,updated_by:integer:foreignKey(users),updated_at:integer
 */
class m190510_101608_create_garages_table extends Migration
{
    /**
     * {@inheritdoc}
     */
