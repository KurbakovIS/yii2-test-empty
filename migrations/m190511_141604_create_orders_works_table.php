 ...
 * - `{{%works}}`
 *
 * yii migrate/create create_orders_works_table --fields=id_order:integer:foreignKey(orders),id_work:integer:foreignKey(works)
 *
 */
class m190511_141604_create_orders_works_table extends Migration
{
    /**
     * {@inheritdoc}
     */
